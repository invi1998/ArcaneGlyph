...
namespace ArcaneGameplayTags
{
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_ChangeComboType_ThrustingStaff);		// 输入标签：切换连招类型：戳棍
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_SpecialWeaponAbility_Freeze);		// 输入标签：特殊武器技能：定身
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Event_Charge_Start);			// 玩家事件：蓄力开始
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Event_Charge_EnterLoop);			// 玩家事件：蓄力进入循环
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Event_SpawnStealthPhantom);		// 玩家事件：生成隐身幻影
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Jump);				// 玩家技能：跳跃
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_SpecialWeaponAbility_Freeze);	// 玩家技能：特殊武器技能：定身
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_ChangeComboType_CleavingStaff);	// 玩家技能：切换连招类型：劈棍
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_ChangeComboType_ThrustingStaff);	// 玩家技能：切换连招类型：戳棍
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_JumpAttack_Light);	// 玩家技能：跳跃攻击：轻
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_JumpAttack_Heavy);	// 玩家技能：跳跃攻击：重
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Cooldown_SpecialWeaponAbility_Freeze);	// 玩家冷却：特殊武器技能：定身
	
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Status_JumpAttack_Activating);	// 玩家状态：跳跃攻击激活中
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Status_Jumping);			// 玩家状态：跳跃中
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Status_JumpAttacking);		// 玩家状态：跳跃攻击中
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Status_StenlthPhantom);	// 玩家状态：隐身幻影
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_ComboType_CleavingStaff);		// 玩家连招类型：劈棍
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_ComboType_ThrustingStaff);		// 玩家连招类型：戳棍
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_SetByCaller_PreEnergy);			// 玩家设置：气力扣除前值
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Event_ShipoSuccess);		// 共享事件：识破招式成功
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Event_Freeze);			// 共享事件：冻结（定身）
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_Ability_Freeze);			// 共享技能：被冻结（定身）
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shared_SetByCaller_RageGainOrCost);	// 共享：愤怒获取或消耗
	...
	// Gameplay Tags for SaveGame
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameData_SaveGame_Slot_1);		// 存档标签：存档槽1
	...
	ARCANEGLYPH_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Frontend_Widget_Frontend_OptionsScreen);		// 前端标签：选项屏幕
